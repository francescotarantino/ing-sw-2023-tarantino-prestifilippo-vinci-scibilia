...
public class LivingRoomBoardTest {
    final int[][] invalidPositionsTwoPlayers = {{0, 0},{0, 1},{0, 2},{0, 5},{0, 6},{0, 7},{0, 8},{1, 0},{1, 1},{1, 2},{1, 6},{1, 7},{1, 8},{2, 0},{2, 1},{2, 7},{2, 8},{3, 0},{5, 8},{6, 0},{6, 1},{6, 7},{6, 8},{7, 0},{7, 1},{7, 2},{7, 6},{7, 7},{7, 8},{8, 0},{8, 1},{8, 2},{8, 3},{8, 6},{8, 7},{8, 8},{0, 4},{1, 5},{3, 1},{4, 0},{4, 8},{5, 7},{7, 3},{8, 4},{0, 3},{2, 2},{2, 6},{3, 8},{5, 0},{6, 2},{6, 6},{8, 5}};

    final int[][] invalidPositionsThreePlayers = {{0, 0},{0, 1},{0, 2},{0, 5},{0, 6},{0, 7},{0, 8},{1, 0},{1, 1},{1, 2},{1, 6},{1, 7},{1, 8},{2, 0},{2, 1},{2, 7},{2, 8},{3, 0},{5, 8},{6, 0},{6, 1},{6, 7},{6, 8},{7, 0},{7, 1},{7, 2},{7, 6},{7, 7},{7, 8},{8, 0},{8, 1},{8, 2},{8, 3},{8, 6},{8, 7},{8, 8},{0, 4},{1, 5},{3, 1},{4, 0},{4, 8},{5, 7},{7, 3},{8, 4}};

    final int[][] invalidPositionsFourPlayers = {{0, 0},{0, 1},{0, 2},{0, 5},{0, 6},{0, 7},{0, 8},{1, 0},{1, 1},{1, 2},{1, 6},{1, 7},{1, 8},{2, 0},{2, 1},{2, 7},{2, 8},{3, 0},{5, 8},{6, 0},{6, 1},{6, 7},{6, 8},{7, 0},{7, 1},{7, 2},{7, 6},{7, 7},{7, 8},{8, 0},{8, 1},{8, 2},{8, 3},{8, 6},{8, 7},{8, 8}};

    final Tile t = new Tile(Constants.TileType.CATS);
